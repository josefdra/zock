...
int total_games(71 * 10 * 10 * 10);
int total_finished_games(0);
uint8_t most_won_games(27);
uint8_t best_mult1(1);
uint8_t best_mult2(8);
uint8_t best_mult3(9);
    ...
    while (1)
    {
        for (glob_mult1 = 1; glob_mult1 < variations; glob_mult1++)
        {
            ...
            for (glob_mult2 = 1; glob_mult2 < variations; glob_mult2++)
            {
                ...
                {
                    if(glob_mult1 == 1 && glob_mult2 == 1 && glob_mult3 == 1){
                        glob_mult1 = 2;
                        glob_mult2 = 6;
                        glob_mult3 = 10;
                    }
                    ...
                    message = "Starting match " + std::to_string((int)(10 * 10 * glob_mult1 - 10 * 10 + 10 * glob_mult2 - 10 + glob_mult3)) + " with this configuration: " + std::to_string((int)glob_mult1) + " " + std::to_string((int)glob_mult2) + " " + std::to_string((int)glob_mult3);
                    print_to_file(message);
