...
#define MOVE_MULTIPLIER 20
#define STONE_MULTIPLIER 6
#define ENEMY_MOVE_MULTIPLIER 10
#define ENEMY_STONE_MULTIPLIER 3
...
#define ENEMY_PROTECTED_FIELD_MULTIPLIER 20
