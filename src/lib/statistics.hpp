...
extern int score;
extern long total_score;
extern int enemy_move_value;
extern long total_enemy_move_value;
extern int enemy_stone_value;
extern long total_enemy_stone_value;
extern int enemy_protected_fields_value;
extern long total_enemy_protected_fields_value;
extern int enemy_static_eval;
extern long total_enemy_static_eval;
extern int our_move_value;
extern long total_our_move_value;
extern int our_stone_value;
extern long total_our_stone_value;
extern int our_protected_fields_value;
extern long total_our_protected_fields_value;
extern int our_static_eval;
extern long total_our_static_eval;
extern int before_bonus_value;
extern long total_before_bonus_value;
extern int before_choice_value;
extern long total_before_choice_value;
extern int overwrite_value;
extern long total_overwrite_value;
extern int no_move_value;
extern long total_no_move_value;
extern int bonus_value;
extern long total_bonus_value;
extern int choice_value;
extern long total_choice_value;
